 ...
 */
import mainCSS from 'bundle-text:./_PixHighlighter.css';
import cyberpunkThemeCSS from 'bundle-text:./Themes/cyberpunk.css';
import darculaThemeCSS from 'bundle-text:./Themes/darcula.css';
import defaultThemeCSS from 'bundle-text:./Themes/default.css';
import prettyLightsThemeCSS from 'bundle-text:./Themes/prettylights.css';
import prismThemeCSS from 'bundle-text:./Themes/prism.css';
import monokaiThemeCSS from 'bundle-text:./Themes/monokai.css';
import nordThemeCSS from 'bundle-text:./Themes/nord.css';
import themeDefaultsCSS from 'bundle-text:./Themes/theme-defaults.css';
