...
description: 'When native lazy loading is enough, when IntersectionObserver is the right tool, and the specific cases where mixing both is the only correct answer. No, they are not the same thing.'
canonical_url: false
---
