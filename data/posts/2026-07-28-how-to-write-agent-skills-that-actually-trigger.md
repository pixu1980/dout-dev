...
series: ['How I made it', 'AI']
description: 'Anthropic guide to Claude skills is more useful than it first appears: the real lessons are about routing, narrow workflows, progressive disclosure, and deterministic checks.'
canonical_url: false
---
