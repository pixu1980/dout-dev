...
description: 'How dout.dev ships a search experience without a backend: prebuilt JSON indexes, a light ranking function, URL-driven filters and pagination. No server required.'
canonical_url: false
---

## The constraint (no backend, no excuses)

A static blog has no backend. That is the whole fucking point. So search has to satisfy three rules:
