...
description: 'A scrollspy that survives keyboard navigation, announces correctly to screen readers, and does not require hacky patterns. I fixed the three things most implementations get wrong.'
canonical_url: false
---
